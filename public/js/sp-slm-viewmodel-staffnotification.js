//---------------------------------------------------------------------------
// Author: Thabiso Ntoi, 08 April 2016 
//---------------------------------------------------------------------------
var ViewModelNewsNotification = function () {
    var self = this;
    ...
    // constants
    self.api_notification_author_query = get_slm_URL_Intranet() + "/_api/web/lists/GetByTitle(\'" + slm_LIST_NewsNotification_Title + "\')/items?$select=id,NotificationAuthor/Title,NotificationAuthor/Name&$expand=NotificationAuthor&$orderby=NotificationDate desc&$filter=NotificationDate le datetime'{0}'";
    self.api_notification_query = get_slm_URL_Intranet() + "/_api/web/lists/GetByTitle(\'" + slm_LIST_NewsNotification_Title + "\')/GetItems(query=@v1)?@v1={\"ViewXml\":\"<View><ViewFields><FieldRef Name='Id'/><FieldRef Name='Title'/><FieldRef Name='NotificationMessage'/><FieldRef Name='NotificationDate'/><FieldRef Name='NotificationType'/><FieldRef Name='NotificationTarget'/></ViewFields><Query><OrderBy><FieldRef Ascending='FALSE' Name='NotificationDate'/></OrderBy><Where><And><And><Or><Geq><FieldRef Name='DisplayEndDate'/><Value Type='DateTime'><Today/></Value></Geq><IsNull><FieldRef Name='DisplayEndDate'/></IsNull></Or><Leq><FieldRef Name='NotificationDate'/><Value IncludeTimeValue='TRUE' Type='DateTime'><Today/></Value></Leq></And>{0}</And></Where></Query></View>\"}";
    ...
    self.string_default_heading = "Main Heading";
   ...
   //self.html_social_link = "<a class='notiSocialLink' href='{0}'>{1}</a>";
    ...
    ViewModelNewsNotification.dataobjectNotification = dataobjectNotification;
    ...
    self.notificationArray = ko.computed(function () {
        try {
            ...
            if (self.selectedFilter() == self.string_latest_filter) {
                // Latest filter
            ...
            console.log("Error: ViewModelNewsNotification.notificationArray: " + err);
        }
    ...
    //-----------------------------------------------------------------------
    self.populateMappedItem = function (nid, ntitle, nauthor, npicture, ndate, nmessage, ntype, nlink, ntarget, nread, narray, nheading) {
        try {
            ...
            obj.NotificationDate(parser.getValueDefault(moment(ndate).format("dddd, DD MMM YYYY")));
            ...
            console.log("Error: ViewModelNewsNotification.populateMappedItem: " + err);
        }
    };
    ...
    self.populateMappedStatus = function (id, nid, ntitle, nread) {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.populateMappedStatus: " + err);
        }
    };
    ...
    self.populateNotifications = function (data) {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.populateNotifications: " + err);
        }
    };
    ...
    self.updateNotifications = function (data) {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.updateNotifications: " + err);
        }
    };
    ...
    self.populateSocial = function (data, feedType) {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.populateSocial: " + err);
        }
    };
    ...
    self.buildOverlay = function (post, actors, feedType) {
        try {
            ...
            if(completeHtml.length <= self.int_max_message) {
                $.each(reversedOverlays, function (i, overlay) {
                    try {
                        ...
                        console.log("Error: ViewModelNewsNotification.buildOverlay: "+ feedType +" item error: " + fiErr);
                    }
                });
            } else {
                ...
                $.each(reversedOverlays, function (i, overlay) {
                    try {
                        ...
                        console.log("Error: ViewModelNewsNotification.buildOverlay-->start: "+ feedType +" item error: " + fiErr);
                    }
                });
                $.each(reversedOverlays, function (i, overlay) {
                    try {
            ...
            console.log("Error: ViewModelNewsNotification.buildOverlay: " + feedType +" error: " + err);
        }
    };
    ...
    self.buildSocialLink = function (text, link, feedType) {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.buildSocialLink: " + feedType +" error: " + err);
        }
    };
    ...
    self.load = function () {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.load: " + err);
        }
    ...
    self.loadData = function () {
        ...
        try {
            ...
            console.log("Error: ViewModelNewsNotification.loadData: " + err);
        }
    };
    ...
    self.loadFilters = function () {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.loadFilters: " + err);
        }
    };
    ...
    self.FinishedLoading = function () {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.FinishedLoading: " + err);
        }
    };
    ...
    self.getNotificationStatusCached = function () {
        ...
        try {
            ...
            console.log("Error: ViewModelNewsNotification.getNotificationStatusCached:" + err.message);
        }
    ...
    self.checkForNotificatonFolder = function () {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.checkForNotificatonFolder: " + err);
        }
    };
    ...
    self.createNotificationFolder = function () {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.createNotificationFolder: " + err);
        }
    };
    ...
    self.createNotificationStatus = function (nid, ntitle, nread) {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.createNotificationStatus: " + err);
        }
    };
    ...
    self.getNotificationFolderItems = function () {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.getNotificationFolderItems: " + err);
        }
    };
    ...
    self.processNotificationStatuses = function () {
        try {
            ...
            console.log("Error: ViewModelNewsNotification.processNotificationStatuses: " + err);
        }
    };
    ...
    self.logFailure = function (method, message) {
        console.log("Error: ViewModelNewsNotification." + method + ": " + message);
    };
    ...
    self.markAsRead = function () {
        try {
            ...
            console.log("Error->ViewModelNewsNotification: markAsRead click: " + err);
        }
    };
    ...
    self.changeFilter = function () {
        try {
            ...
            console.log("Error->ViewModelNewsNotification: changeFilter click: " + err);
        }
    };
};
...
$(document).ready(function () {
    SP.SOD.executeFunc('sp.js', 'SP.ClientContext', function () {
         try {
                ...
                var viewModelBaseElement = document.getElementById("slmNewsNotification");

                // bind if viewmodel element found
                if (viewModelBaseElement) {
                    var viewModelNBoard = new ViewModelNewsNotification();
                ...
                console.log("Error->ViewModelNewsNotification: Document ready / ApplyBindings: " + err);
            }
      });
});
